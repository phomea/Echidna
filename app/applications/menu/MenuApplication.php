...
class MenuApplication extends Application {
    ...
    static function init($n)
    {
        ...
        $menu = new \backend\Menu("Menu","menu");
        $menu->addItem("Lista",RouterService::getRoute(Menu::getEntity().".list"));
        $menu->addItem("Aggiungi",RouterService::getRoute(Menu::getEntity().".add"));
