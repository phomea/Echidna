...
class MetodoPagamento extends Model{
    ...
    static function schema()
    {
        return[
            ...
            "infomail"  =>  Field::text()->editable()->setTemplate("tinymce"),

            "secret_key"    =>  Field::varchar(256)->editable()->hideIf("type",[
                "braintree","contrassegno","bonifico","paypal"
            ]),
            "publishable_key"   =>  Field::varchar(512)->editable()->hideIf("type",[
                "braintree","contrassegno","bonifico","paypal"
            ])
        ];
    }
    ...
    function processOrder($cliente,$carrello,$data=null){
        ...
        $pagamento = new $gateway($cliente,$carrello,$this->id,$this);
        $pagamento->data = $data;
