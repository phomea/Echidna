...
class Attributo extends Model{
    ...
    static function schema()
    {
        return [
            ...
            "tipo"      =>  Field::int()->setTemplate("select")->editable()->setTemplateVar(function(){
                return AttributoTipo::getForSelect("tipo","id");
            }),
            "parent"      =>  Field::int()->setTemplate("select")->editable()->setTemplateVar(function(){
                return Attributo::getForSelect("nome","id");
            }),
