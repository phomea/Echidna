...
class TipologiaProdotto extends Model{
    ...
    static function schema()
    {
        return [
            ...
            "id_tipologia_prodotto" =>  Field::int()->editable()->setTemplate("select")->setTemplateVar([\applications\ecommerce\TipologiaProdotto::class,"getForSelect"])->index()
        ];
    }
    ...
    public function getFields(){
        ...
        $cc = TipologiaProdottoCampo::query()
        ->where("id_ecommerce_tipologia_prodotto=".$this->id)->getAll();
