...
class TipologiaProdotto extends BackendApplication {
    ...
    static function actionMod($params = [])
    {
        ...
        $tabprodottiAssociati = Prodotti::actionComplessList([
            "params"    =>  "/where/id_ecommerce_tipologia_prodotto=".$r[1]["data"]->id,
            ...
            'tabs',[
                "tabs"  =>  [
                    ...
                    //    "content"   => Response::getTemplateToUse( "list",$prodottiAssociati[1],"empty.twig")->render(),
                        "content"   =>  BackendTemplate::renderTemplate($tabprodottiAssociati[0],$tabprodottiAssociati[1])
