...
trait metodiCatalogoCategoria{
    ...
    static function editCategoria( $params ){
        ...
        $mod = self::actionMod($params); // TODO: Change the autogenerated stub
        ...
        $cptable = CategoriaProdotto::getTable();
        $cpProdotto = Prodotto::getTable();
        $tabProdotti = Prodotti::actionComplessList([
            "params"    =>  "join/$cptable on $cptable.id_prodotto=$cpProdotto.id/where/$cptable.id_categoria=".$mod[1]["data"]->id,
        ...
        return[
            "tabs", [
                "tabs" =>[
                    "proprieta" => [
                        "label" =>  "Proprietà",
                        "content"   => $e /*  Response::getTemplateToUse("mod",[
                            "title" =>  "Modifica",
                            "data"  =>  $data,
                            "fields"    =>  $fields,
                            "entity"    =>  Categoria::class
                    ...
                    "prodotti"  =>[
                        "label" =>  "Prodotti",
                        "content"=> BackendTemplate::renderTemplate($tabProdotti[0],$tabProdotti[1])
                    ],
                    "meta"    =>  [
                        "label" =>  "Meta",
                        "content"   => $metaform
