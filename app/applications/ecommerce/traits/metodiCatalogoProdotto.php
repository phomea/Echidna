...
use applications\ecommerce\Varianti;
...
trait metodiCatalogoProdotto{
    ...
    static function listaProdotti(){
        $data = Prodotto::query(true)->getAll();
    ...
    static function editProdotto( $params ){
        ...
        $tabVarianti = Varianti::actionComplessList([
            "params"    =>  "/where/id_prodotto=".$mod[1]["data"]->id,
            "routeParams"=>[
                "id_prodotto"   =>  $mod[1]["data"]->id
            ]
        ]);
        return [
            "tabs",[
                "tabs"=>[
                    "pagina"    =>  [
                        "label" =>  "Proprietà",
                        "content"   =>  $e /* Response::getTemplateToUse(
                    ...
                    "varianti"    => [
                        "label" =>  "Varianti",
                        "content"   =>  BackendTemplate::renderTemplate("list-edit",$tabVarianti[1])
                    ]
    ...
    static function removeCategories( $params = [], $data = null){
        ...
        foreach ($ids as $key=>$id_category){
            $present = CategoriaProdotto::query()->where("id_categoria=".$id_category)->where("id_prodotto=".$idProdotto)->getAll();
