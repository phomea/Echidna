...
class TipiStanzaBackend extends \core\abstracts\BackendApplication{
    ...
    public static function actionMod($params = [])
    {
        ...
        $m[1]["title"] = "Modifica Tipologia Stanza: ".$m[1]["data"]->nomeTipoStanza;
        return $m;
    }
    ...
    public static function actionList($params = [])
    {
        ...
        $m[1]['title'] = "Elenco delle Tipologie di Stanza";
        return $m;
    }
