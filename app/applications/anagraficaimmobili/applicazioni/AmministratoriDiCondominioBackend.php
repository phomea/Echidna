...
class AmministratoriDiCondominioBackend extends \core\abstracts\BackendApplication{
    ...
    public static function actionMod($params = [])
    {
        ...
        $m[1]['title'] = "Modifica anagrafica Amministratore di Condominio";
        return $m;
    }
    ...
    public static function actionAdd($params = [])
    {
        ...
        $m[1]['title'] = "Aggiungi nuovo Amministratore di Condominio";
        return $m;
    }
