...
class ClientiFatturazioneBackend extends \core\abstracts\BackendApplication{
    ...
    public static function actionMod($params = [])
    {
        ...
        $m[1]['title'] = "Modifica anagrafica Proprietario di Immobile";
        return $m;
    }
    ...
    public static function actionAdd($params = [])
    {
        ...
        $m[1]['title'] = "Aggiungi nuovo Proprietario di Immobile";
        return $m;
    }
