...
class Request extends Service{
    ...
    const AJAX_REQUEST_NAME = "X-Requested-With";
    ...
    static function init(){
      ...
      Response::addVariable([
          "host"    =>  Request::$host,
          "demoMode"    =>  SessionService::get(MainBackend::DEMOMODE_KEY)
        ]);
      ...
      self::$get = $_GET;
      self::$query = isset($_GET['query']) ? $_GET['query'] : "";
      self::$post = $_POST;
    ...
    static function getParamsClean(){
        $n = self::getParams();
        unset($n['query']);
    ...
    static function getData(){
        if(Request::getMethod() == "PUT" ){
            return self::getPutData();
        }elseif (Request::getMethod() == 'POST'){
            return self::getPost();
        }
    }

    static function getPutData(){
