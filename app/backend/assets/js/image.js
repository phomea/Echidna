...
jQuery.expr[':'].Contains = function(a, i, m) {
    ...
    var MediaBrowser = function(){
        ...
        this.fromUrl = function(e){
            ...
            url = prompt("Inserisci la url completa dell'immagine");
        ...
        this.createWindow = function(){
            ...
            me.searchInput = $('<input class="media-filter-input" placeholder="Filtra" >');
            ...
            me.searchInput.on("keyup",function( e ){
                ...
                if(e.which == 13){
                    me.list.find(".fileBroswer-entry:visible").first().dblclick();


                    return;
                }

                me.list.find(".fileBroswer-entry").hide();

                me.list.find('*:Contains("'+$(this).val()+'")').each(function(){
                    $(this).closest(".fileBroswer-entry").show();
                })
            })
            ...
            this.navigation.append(me.searchInput);
