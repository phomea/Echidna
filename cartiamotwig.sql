...
--
-- Host: localhost:3306
-- Generation Time: Jul 05, 2018 at 07:04 AM
...
CREATE TABLE `ecommerce_attributo_entita` (
  ...
  `id_attrbuto` int(11) DEFAULT NULL,
...
INSERT INTO `ecommerce_attributo_entita` (`id`, `entita`, `id_attrbuto`, `id_entita`) VALUES
(1, 'ecommerce_tipologia_prodotto', 1, 1);
...
INSERT INTO `ecommerce_prodotto` (`id`, `nome`, `slug`, `descrizione`, `id_ecommerce_tipologia_prodotto`) VALUES
(1, 'Divano', 'divano', 'asasdas', 2),
(2, 'Prova nuovo prodotto', 'prova-nuovo-prodotto', 'asd', 2),
(3, 'Prova nuovo prodotto ancora', 'prova-nuovo-prodotto-ancora', 'asd', 1);
