...
--
-- Host: localhost:3306
-- Generation Time: Jul 11, 2018 at 12:56 PM
...
CREATE TABLE IF NOT EXISTS `clprodotto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cl_articolo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cl_campioneomaggio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` text,
  `cognome` text,
  `email` text,
...
CREATE TABLE IF NOT EXISTS `cl_categoria` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cl_meta_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cl_strutturadati` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` text,
  `value` text,
...
CREATE TABLE IF NOT EXISTS `cl_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` text,
  `nomemacchina` text,
  `descrizione` text,
...
CREATE TABLE IF NOT EXISTS `ecommerce_attributo` (
...
CREATE TABLE IF NOT EXISTS `ecommerce_attributo_entita` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(20, 'ecommerce_tipologia_prodotto', 6, 3),
(21, 'ecommerce_tipologia_prodotto', 7, 3),
(22, 'ecommerce_tipologia_prodotto', 5, 4);
...
CREATE TABLE IF NOT EXISTS `ecommerce_attributo_valore` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ecommerce_categoria_prodotto` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ecommerce_cliente` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` varchar(512) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ecommerce_cliente_spedizione` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` varchar(512) COLLATE utf8_bin DEFAULT NULL,
  `cognome` varchar(512) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ecommerce_country` (
...
CREATE TABLE IF NOT EXISTS `ecommerce_ordine` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `id_cliente` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ecommerce_prodotto` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` varchar(256) COLLATE utf8_bin DEFAULT NULL,
  `slug` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `descrizione` text COLLATE utf8_bin,
...
(6, 'Poltrona Firenze ITC-2019', 'poltrona-firenze-itc-2019', '', 3, 'ITC-2019'),
(7, 'Divano ITC-2019', 'divano-itc-2019', '', 3, 'ITC-2019'),
(8, 'Divani', 'divani', '', 5, '');
...
CREATE TABLE IF NOT EXISTS `ecommerce_prodotto_campi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ecommerce_prodotto_immagine` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ecommerce_prodotto_variante` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_prodotto` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ecommerce_prodotto_variante_attributi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ecommerce_prodotto_variante_campi` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ecommerce_provincia` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ecommerce_spedizione` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` varchar(512) COLLATE utf8_bin DEFAULT NULL,
  `sku` varchar(512) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ecommerce_spedizione_prezzo` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ecommerce_tipologia_prodotto` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` varchar(256) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ecommerce_tipologia_prodotto_campi` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` varchar(512) COLLATE utf8_bin DEFAULT NULL,
  `slug` varchar(512) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ecommerce_zona` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
  `active` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `gp_attivita` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gp_progetti` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` text,
  `descrizione` longtext,
  `tipo` text,
...
CREATE TABLE IF NOT EXISTS `gp_scadenze` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gp_tipologie_attivita` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` text,
  `descrizione` text,
  PRIMARY KEY (`id`)
